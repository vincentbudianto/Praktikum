...
int main()
{
	...
	printf ("Jam 1 + 1 detik: "); TulisJAM(NextDetik(J1));
	printf ("\n");
	//TEST NextNDetik
	printf ("TEST NextNDetik\n");
	printf ("+ detik : "); scanf ("%d", &y);
	printf ("Jam 1 + %d detik: ", y); TulisJAM(NextNDetik(J1, y));
	printf ("\n");
	//TEST PrevDetik
	printf ("TEST PrevDetik\n");
	printf ("Jam 1 : "); TulisJAM(PrevDetik(J1));
	printf ("\n");
	//TEST PrevNDetik
	printf ("TEST PrevNDetik\n");
	printf ("- detik : "); scanf ("%d", &z);
	printf ("Jam 1 - %d detik: ", z); TulisJAM(PrevNDetik(J1,z));
	printf ("\n");
	//TEST DURASI
	printf ("TEST DURASI\n");
	printf ("durasi j1 J1: %ld\n", (Durasi(J1, J2)));
	return 0;
}
